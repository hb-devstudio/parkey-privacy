...
Ce dépôt contient la politique de confidentialité de l'application mobile **Parkey**.

## 📄 Accès à la Politique

La politique de confidentialité complète est disponible dans le fichier **[PRIVACY.md](./PRIVACY.md)**.

**URL directe :** https://github.com/hb-devstudio/parkey-privacy/blob/main/PRIVACY.md

## 📱 À propos de Parkey

Parkey est une application mobile permettant la location de places de parking entre particuliers.
